    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds)
    {
        ...
        for(int i = 0 ; i < N ; i++)
        {
            ...
            if(sets.getInt("color", 1) == 3){
                ...
                views.setImageViewResource(R.id.board, R.drawable.hangulclock_board_pink);
            }


            if(sets.getInt("color", 1) == 4){
                views.setTextColor(R.id.textView1, Color.rgb(202, 72, 51));
                views.setImageViewResource(R.id.board, R.drawable.hangulclock_board_red);
            }


            if(sets.getInt("color", 1) == 5){
                views.setTextColor(R.id.textView1, Color.rgb(232, 190, 88));
                views.setImageViewResource(R.id.board, R.drawable.hangulclock_board_orange);
            }

            if(sets.getInt("color", 1) == 6){
                views.setTextColor(R.id.textView1, Color.rgb(149, 211, 101));
                views.setImageViewResource(R.id.board, R.drawable.hangulclock_board_green);
            }


            if(sets.getInt("color", 1) == 7){
                views.setTextColor(R.id.textView1, Color.rgb(98, 164, 157));
                views.setImageViewResource(R.id.board, R.drawable.hangulclock_board_bluegreen);
            }
            ...
            views.setTextColor(R.id.fc, Color.argb(65, 67, 70, 90));
            ...
            if(hour == 1 || hour == 13){
                ...
                if(sets.getInt("color", 1) == 3)//pink
                {
                    views.setTextColor(R.id.aa, Color.WHITE);
                    views.setTextColor(R.id.fc, Color.WHITE);
                }
                if(sets.getInt("color", 1) == 4)//red
                {
                    views.setTextColor(R.id.aa, Color.WHITE);
                    views.setTextColor(R.id.fc, Color.WHITE);
                }
                if(sets.getInt("color", 1) == 5)//orange
                {
                    views.setTextColor(R.id.aa, Color.WHITE);
                    views.setTextColor(R.id.fc, Color.WHITE);
                }
                if(sets.getInt("color", 1) == 6)//green
                {
                    views.setTextColor(R.id.aa, Color.WHITE);
                    views.setTextColor(R.id.fc, Color.WHITE);
                }
                if(sets.getInt("color", 1) == 7)//bluegreen
                {
                    views.setTextColor(R.id.aa, Color.WHITE);
                    views.setTextColor(R.id.fc, Color.WHITE);
                }
